...
var config = {
    ...
    emotions: [{
        ...
        {src: 'moudle/mood/images/smilea_thumb.gif',alt: '[呵呵]'},
        {src: 'moudle/mood/images/tootha_thumb.gif',alt: '[嘻嘻]'},
        {src: 'moudle/mood/images/laugh.gif',alt: '[哈哈]'},
        {src: 'moudle/mood/images/tza_thumb.gif',alt: '[可爱]'},
        {src: 'moudle/mood/images/kl_thumb.gif',alt: '[可怜]'},
        {src: 'moudle/mood/images/kbsa_thumb.gif',alt: '[挖鼻屎]'},
        {src: 'moudle/mood/images/cj_thumb.gif',alt: '[吃惊]'},
        {src: 'moudle/mood/images/shamea_thumb.gif',alt: '[害羞]'},
        {src: 'moudle/mood/images/zy_thumb.gif',alt: '[挤眼]'},
        {src: 'moudle/mood/images/bz_thumb.gif',alt: '[闭嘴]'},
        {src: 'moudle/mood/images/bs2_thumb.gif',alt: '[鄙视]'},
        {src: 'moudle/mood/images/lovea_thumb.gif',alt: '[爱你]'},
        {src: 'moudle/mood/images/sada_thumb.gif',alt: '[泪]'},
        {src: 'moudle/mood/images/heia_thumb.gif',alt: '[偷笑]'},
        {src: 'moudle/mood/images/qq_thumb.gif',alt: '[亲亲]'},
        {src: 'moudle/mood/images/sb_thumb.gif',alt: '[生病]'},
        {src: 'moudle/mood/images/mb_thumb.gif',alt: '[太开心]'},
        {src: 'moudle/mood/images/ldln_thumb.gif',alt: '[懒得理你]'},
        {src: 'moudle/mood/images/yhh_thumb.gif',alt: '[右哼哼]'},
        {src: 'moudle/mood/images/zhh_thumb.gif',alt: '[左哼哼]'},
        {src: 'moudle/mood/images/x_thumb.gif',alt: '[嘘]'},
        {src: 'moudle/mood/images/cry.gif',alt: '[衰]'},
        {src: 'moudle/mood/images/wq_thumb.gif',alt: '[委屈]'},
        {src: 'moudle/mood/images/t_thumb.gif',alt: '[吐]'},
        {src: 'moudle/mood/images/k_thumb.gif',alt: '[打哈气]'},
        {src: 'moudle/mood/images/bba_thumb.gif',alt: '[抱抱]'},
        {src: 'moudle/mood/images/angrya_thumb.gif',alt: '[怒]'},
        {src: 'moudle/mood/images/yw_thumb.gif',alt: '[疑问]'},
        {src: 'moudle/mood/images/cza_thumb.gif',alt: '[馋嘴]'},
        {src: 'moudle/mood/images/88_thumb.gif',alt: '[拜拜]'},
        {src: 'moudle/mood/images/sk_thumb.gif',alt: '[思考]'},
        {src: 'moudle/mood/images/sweata_thumb.gif',alt: '[汗]'},
        {src: 'moudle/mood/images/sleepya_thumb.gif',alt: '[困]'},
        {src: 'moudle/mood/images/sleepa_thumb.gif',alt: '[睡觉]'},
        {src: 'moudle/mood/images/money_thumb.gif',alt: '[钱]'},
        {src: 'moudle/mood/images/sw_thumb.gif',alt: '[失望]'},
        {src: 'moudle/mood/images/cool_thumb.gif',alt: '[酷]'},
        {src: 'moudle/mood/images/hsa_thumb.gif',alt: '[花心]'},
        {src: 'moudle/mood/images/hatea_thumb.gif',alt: '[哼]'},
        {src: 'moudle/mood/images/gza_thumb.gif',alt: '[鼓掌]'},
        {src: 'moudle/mood/images/dizzya_thumb.gif',alt: '[晕]'},
        {src: 'moudle/mood/images/bs_thumb.gif',alt: '[悲伤]'},
        {src: 'moudle/mood/images/crazya_thumb.gif',alt: '[抓狂]'},
        {src: 'moudle/mood/images/h_thumb.gif',alt: '[黑线]'},
        {src: 'moudle/mood/images/yx_thumb.gif',alt: '[阴险]'},
        {src: 'moudle/mood/images/nm_thumb.gif',alt: '[怒骂]'},
        {src: 'moudle/mood/images/hearta_thumb.gif',alt: '[心]'},
        {src: 'moudle/mood/images/unheart.gif',alt: '[伤心]'},
        {src: 'moudle/mood/images/pig.gif',alt: '[猪头]'},
        {src: 'moudle/mood/images/ok_thumb.gif',alt: '[ok]'},
        {src: 'moudle/mood/images/ye_thumb.gif',alt: '[耶]'},
        {src: 'moudle/mood/images/good_thumb.gif',alt: '[good]'},
        {src: 'moudle/mood/images/no_thumb.gif',alt: '[不要]'},
        {src: 'moudle/mood/images/z2_thumb.gif',alt: '[赞]'},
        {src: 'moudle/mood/images/come_thumb.gif',alt: '[来]'},
        {src: 'moudle/mood/images/sad_thumb.gif',alt: '[弱]'},
        {src: 'moudle/mood/images/lazu_thumb.gif',alt: '[蜡烛]'},
        {src: 'moudle/mood/images/clock_thumb.gif',alt: '[钟]'},
        {src: 'moudle/mood/images/cake.gif',alt: '[蛋糕]'},
        {src: 'moudle/mood/images/m_thumb.gif',alt: '[话筒]'},
        {src: 'moudle/mood/images/weijin_thumb.gif',alt: '[围脖]'},
        {src: 'moudle/mood/images/lxhzhuanfa_thumb.gif',alt: '[转发]'},
        {src: 'moudle/mood/images/lxhluguo_thumb.gif',alt: '[路过这儿]'},
        {src: 'moudle/mood/images/bofubianlian_thumb.gif',alt: '[bofu变脸]'},
        {src: 'moudle/mood/images/gbzkun_thumb.gif',alt: '[gbz困]'},
        {src: 'moudle/mood/images/boboshengmenqi_thumb.gif',alt: '[生闷气]'},
        {src: 'moudle/mood/images/chn_buyaoya_thumb.gif',alt: '[不要啊]'},
        {src: 'moudle/mood/images/daxiongleibenxiong_thumb.gif',alt: '[dx泪奔]'},
        {src: 'moudle/mood/images/cat_yunqizhong_thumb.gif',alt: '[运气中]'},
        {src: 'moudle/mood/images/youqian_thumb.gif',alt: '[有钱]'},
        ]
    }, {
        // tab 的标题
        title: '新浪',
...
Editor.prototype = {
    ...
    _initDom: function _initDom() {
        ...
        if (textSelector == null) {
            ...
            // 自行创建的，需要配置默认的样式
            $toolbarElem.css('background-color', '#f1f1f1').css('border', '1px solid #ccc111');
            $textContainerElem.css('border', '1px solid #ccc').css('border-top', 'none').css('height', '180px');
        } else {
